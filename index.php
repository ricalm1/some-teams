...
<body>
    <header><a href= "about.php"> About </a></header> 

    <div class= "team-card">
        <a href = "https://www.fcbarcelona.com/" class = "team-button">
             <img src = 'https://upload.wikimedia.org/wikipedia/en/4/47/FC_Barcelona_%28crest%29.svg' alt = "Logo for FC Barcelona"> FC Barcelona </a>
                    <div class = "information"> 
                        <p> League: Primera División (Spain)</p>
                        <p> UEFA-Coefficient ranking : 1 </p>
                        <p> City: Barcelona</p>
                        <p> Group: D </p>   
